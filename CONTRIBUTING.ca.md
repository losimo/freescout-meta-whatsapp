...
**El vostre idioma hi és benvingut, i no cal que escriviu PHP.** El FreeScout porta una pantalla de traducció integrada, i llegeix també els mòduls de la comunitat: aneu a Gestionar » Traduir, premeu Importar traduccions, trieu el grup MetaWhatsApp i traduïu des del navegador. La [guia pas a pas](https://github.com/freescout-help-desk/freescout/wiki/Translate) del mateix FreeScout ho explica. Feu-nos arribar el resultat com us vagi millor, per un issue, una pull request o un correu, i sortirà a la versió següent.

Les cadenes noves arriben primer en anglès, i un idioma que encara no les tingui ensenya l'anglès a la pantalla, mai la clau crua. Per tant una traducció mai no bloqueja ni queda trencada, només menys completa del que podria ser.
